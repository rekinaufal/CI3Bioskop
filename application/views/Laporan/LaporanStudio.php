...
<html>
<head>
  <title>Laporan Data Studio</title>
       ...
       <!-- <div class="col-md-6"> untuk memperbesar / memperkecil ukuran-->
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="box-title">Laporan Data Studio</h3>
            <br>
      ...
      <table class="table table-hover" id="dev-table">
        ...
        <tbody id="myTable">
          <?php foreach($DataStudio as $ReadDS) : ?>
            <tr>
              <td><?= $ReadDS->kd_studio; ?></td>
              <td class="status"><?= $ReadDS->nama_studio; ?></td>
            </tr>
          <?php endforeach; ?>
       </tbody>
    </table>
