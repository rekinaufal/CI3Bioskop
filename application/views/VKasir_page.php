...
<!--           <a href="#"><i class="fa fa-circle text-success"></i> Online</a> -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo site_url('Welcome/DataFilm'); ?>"><i class="fa fa-film"></i> <span>Data Film</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataHargaFilm'); ?>"><i class="fa fa-money"></i> <span>Data Harga Film</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataStudio'); ?>"><i class="fa fa-tv"></i> <span>Data Studio</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataTayang'); ?>"><i class="fa fa-calendar-check-o"></i> <span>Data Tayang</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataPembelian'); ?>"><i class="fa fa-balance-scale"></i> <span>Data Pembelian</span></a></li>
        <li>
          <a data-toggle="dropdown" href="<?php echo site_url('Welcome/DataLaporan'); ?>"><i class="fa fa-book"></i> <span>Laporan</span>
          </a>
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" target="blank" href="<?php echo site_url('Welcome/LaporanFilm'); ?>">
                    <i class="fa fa-film"></i>Film</a>
                </li>
                <li><a class="dropdown-item" target="blank" href="<?php echo site_url('Welcome/LaporanHargaFilm'); ?>">
                    <i class="fa fa-money"></i>Harga Film</a>
                </li>
                <li><a class="dropdown-item" target="blank" href="<?php echo site_url('Welcome/LaporanStudio'); ?>">
                    <i class="fa fa-tv"></i>Studio</a>
                </li>
                <li><a class="dropdown-item" target="blank" href="<?php echo site_url('Welcome/LaporanTayang'); ?>">
                    <i class="fa fa-calendar-check-o"></i>Tayang</a>
                </li>
                <li><a class="dropdown-item" target="blank" href="<?php echo site_url('Welcome/LaporanPembelian'); ?>">
                    <i class="fa fa-balance-scale"></i>Pembelian</a>
                </li>
            </ul>
        </li>
